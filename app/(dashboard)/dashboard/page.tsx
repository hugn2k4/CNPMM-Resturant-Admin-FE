                        ...
                        <div className="flex items-center gap-1 mt-1">
                          ...
                          <span
                            className={`text-xs font-medium ${
                              ordersData.trend === "up" ? "text-green-600" : "text-red-600"
                            }`}
                          >
                            {ordersData.change}
                          </span>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                          ...
                          <span
                            className={`text-xs font-medium ${
                              customersData.trend === "up" ? "text-green-600" : "text-red-600"
                            }`}
                          >
                ...
                {recentOrders.map((order) => (
                  ...
                  >
                    ...
                    <div className="text-right space-y-1">
                      ...
                      <Badge variant={getStatusBadge(order.status) as any}>{order.statusText}</Badge>
                    </div>
                  </div>
                ))}
              </div>
